...
class DriverChatVC: MessagesViewController, MessagesDataSource, MessagesLayoutDelegate, MessagesDisplayDelegate {
    
    //var currentSender: SenderType
    var currentSender: SenderType = Sender(senderId: "self", displayName: "Driver")
    
    let currentUser = Sender(senderId: "self", displayName: "Driver")
    ...
    /*
    func currentSender2() -> SenderType {
        return currentUser
    }
     */
